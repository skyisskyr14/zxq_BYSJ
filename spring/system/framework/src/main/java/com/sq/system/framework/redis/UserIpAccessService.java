...
@Component
public class UserIpAccessService {
    ...
    private final String BASEKEY = "USER:OPERATION:LOG:";
    ...
    public void recordUserIpAccess(UserOperationLogEntity log , String token) {
        ...
        try {
            ...
            throw new RuntimeException("存储 User Token LOG 失败", e);
        }
    }

    public UserOperationLogEntity getLogBykey(String key) {
        try {
            String json = stringRedisTemplate.opsForValue().get(key);
            return json != null ? objectMapper.readValue(json, UserOperationLogEntity.class) : null;
        } catch (Exception e) {
            return null;
        }
    }
