<template>
  <div>
    <page-header title="订单列表" desc="查看门店订单" />
    <query-bar :model="query" class="mt-16">
      ...
      <el-form-item label="订单号">
        <el-input v-model="query.keyword" placeholder="搜索订单" />
      </el-form-item>
      <el-form-item>
    ...
    <data-table :data="paged" :loading="loading" class="mt-16">
      ...
      <el-table-column label="操作" width="180">
        <template slot-scope="scope">
          <el-button type="text" @click="$router.push(`/s/order/detail/${scope.row.id}`)">详情</el-button>
